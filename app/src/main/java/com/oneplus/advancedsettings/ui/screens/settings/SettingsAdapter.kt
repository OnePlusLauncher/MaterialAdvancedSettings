...
import com.oneplus.advancedsettings.databinding.*
import com.oneplus.advancedsettings.model.settings.SettingsItem
import com.oneplus.advancedsettings.model.settings.SettingsItemType
import com.oneplus.advancedsettings.utils.Links
import com.oneplus.advancedsettings.utils.openLink
...
class SettingsAdapter(context: Context, private var items: List<SettingsItem>): RecyclerView.Adapter<SettingsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return when(SettingsItemType.values()[viewType]){
            ...
            else ->  ViewHolder.Header(ItemHeaderBinding.inflate(layoutInflater, parent, false))
        }
    }
    ...
    private fun setupSettingSwitch(binding: ItemSettingSwitchBinding, item: SettingsItem.SwitchSetting) = with(binding) {
        ...
        itemSettingSwitchSwitch.isChecked = item.setting
